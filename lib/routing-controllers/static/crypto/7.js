//  #region variable
let cipher = null, iv = null, key = null, data = {};
...
sendToServerBtn.addEventListener("click", async () => {
    let resp = await fetch('/crypto/7d', {
        method: 'POST',
        headers: {
    ...
    resArea2.textContent = "Decrypted message from server => " + resp.decryptedMsg;
    console.log(resp.decryptedMsg);  // resArea.innerText = message;
    res.textContent = (message === resp.decryptedMsg) ? true : false;
});
//  #endregion